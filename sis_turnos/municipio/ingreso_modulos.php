...
<head>
   <meta charset="utf-8" />
   <title>ADMINSITRADOR- INGRESO MODULOS</title>
...
var ruta = "proc_turnos/proc_registro_modulo.php";
};
if ($('#btn_registrar').val()=="GUARDAR") {
      var ruta = "proc_turnos/proc_editar_modulo.php";
};
   ...
   function buscar_persona(valorCaja1){
        ...
        $.ajax({
                data:  parametros,
                url:   'proc_turnos/tabla_modulos.php',
                type:  'post',
                beforeSend: function () {
...
$('.btn_si').click(function(){
   ...
   // alert($('#txtiduser').val());
    var formData = new FormData($("#form_eliminar")[0]);
      var ruta = "proc_turnos/proc_eliminar_modulo.PHP";
            $.ajax({
                url: ruta,
                type: "POST",
                data: formData,
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="ingreso_departamentos.php">Ingresar Módulo</a>
                           <span class="divider">/</span>
                       </li>
                ...
                <div class="span4">
                    ...
                    <div class="widget blue ">
                        <div class="widget-title">
                            <h4><i class="icon-building"></i> Añadir Módulo</h4>
                            <span class="tools">
...
<div id="Info"></div> 
<input type="text" placeholder="Nombre del Módulo (*)" id="nombre_dep" name="nombre_dep" maxlength="45" class="span12  popovers" data-trigger="hover" data-content="Por favor digite el nombre del departamento" data-original-title="NOMBRE" required/>
</div>
<div class="control-group">
<input type="text" placeholder="Abreviatura (*)" id="abreviatura_dep" name="abreviatura_dep" class="span12  popovers" data-trigger="hover" data-content="Por favor digite una abreviatura para el departamento" data-original-title="ABREVIATURA" required/>
</div>
</form>
...
<input type="Button" id="btn_registrar" class="btn btn-success" value="REGISTRAR">
                ...
                <div class="span8">
                    ...
                    <div class="widget blue">
                        <div class="widget-title">
                            <h4><i class="icon-building"> </i> Módulos</h4>
                            <span class="tools">
                                <a href="javascript:;" class="icon-chevron-down"></a>
                                <a href="javascript:;" class="icon-remove"></a>
                            </span>
                        ...
                        <div class="widget-body">
 <input type="text" id="txt_busqueda" placeholder="Nombre del módulo" >
 <div class="control-group">
