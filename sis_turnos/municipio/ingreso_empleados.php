...
<head>
   <meta charset="utf-8" />
   <title>ADMINSITRADOR- INGRESO EMPLEADOS</title>
...
if ($('#btn_registrar').val()=="GUARDAR") {
   ...
   function buscar_persona(valorCaja1){
        ...
        $.ajax({
                data:  parametros,
                url:   'proc_turnos/tabla_usuarios.php',
                type:  'post',
                beforeSend: function () {
            ...
            <div class="row-fluid">
               <div class="span12">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="ingreso_empleados.php">Ingresar Empleados</a>
                           <span class="divider">/</span>
                       </li>
...
<div class="control-group">
<input type="text" placeholder="Nombre (*)" id="nombre" onkeypress="return soloLetras(event)" name="nombre" class="span12  popovers" data-trigger="hover" data-content="Por favor digite el Nombre del usuario" data-original-title="NOMBRE" required/>
</div>
<div class="control-group">
<input type="text" placeholder="Apellido (*)" id="apellido" onkeypress="return soloLetras(event)" name="apellido" class="span12  popovers" data-trigger="hover" data-content="Por favor digite el Apellido del usuario" data-original-title="APELLIDO" required/>
</div>
<div class="control-group">
<input type="text" placeholder="Telefono (*)" id="telefono" name="telefono" onkeypress="return soloNumeros(event)"  maxlength="10" class="span12  popovers" data-trigger="hover" data-content="Por favor digite el nùmero de telefono/celular del usuario" data-original-title="TELEFONO/CELULAR" required/>
</div>
<div class="control-group">
...
<input type="Button" id="btn_registrar" class="btn btn-success" value="REGISTRAR">
                ...
                <div class="span8">
                    ...
                    <div class="widget blue">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"> </i> Empleados</h4>
                            <span class="tools">
                                <a href="javascript:;" class="icon-chevron-down"></a>
                                <a href="javascript:;" class="icon-remove"></a>
                            </span>
