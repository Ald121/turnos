...
$consulta_mod = "SELECT * FROM turnos,turnos_proc where (turnos_proc.estado='EN ESPERA' or turnos_proc.estado='ACTIVO' or turnos_proc.estado='ATENDIDO' or turnos_proc.estado='CANCELADO') and idusuario='".$_SESSION["idusuario"]."' and turnos.nroturno=turnos_proc.nroturno;";
...
$sql = "INSERT INTO turnos(nroturno,nombre_departamento,idusuario,estado,observaciones) VALUES ('" .strval ($newturno). "',
    '" . $departamento . "','" . $_SESSION["idusuario"] . "','EN ESPERA','TURNO ESPECIAL TURNO GENERADO POR EL ADMINISTRADOR')";
