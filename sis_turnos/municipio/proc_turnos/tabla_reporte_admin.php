...
<table class="table table-striped table-bordered table-advance table-hover">
                      <thead>
                                    <tr>
                                        ...
                                        <th><i class=" icon-edit"></i> GENERAR</th>
                                    </tr>
                                                                       </thead>
                                    <tbody>
...
?>
 ...
 <td style="text-transform: uppercase"><strong><button value='<?php echo $filauser['idusuario'];?>' class="btn_siguiente_asig" style="color:#242B5D" id="btn_asignar">GENERAR PDF</button></strong></td>
...
$(".btn_siguiente_asig").on("click", function(){
 var parametros = {
        ...
        $.ajax({
                data:  parametros,
                url:   'proc_turnos/pdf_turnos_x_empleado.php',
                type:  'post',
                beforeSend: function () {
