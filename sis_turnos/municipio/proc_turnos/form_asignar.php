...
<?php
$consultamod = "SELECT nombre_departamento FROM departamentos where idusuario='0';";
$resultadomod = $conexion->query($consultamod)or die ( $conexion->error);
...
?>
<br><br><button type="submit" style="color:#242B5D" name="btn_asignar" id="btn_asignar">ASIGNAR</button>
</form>
