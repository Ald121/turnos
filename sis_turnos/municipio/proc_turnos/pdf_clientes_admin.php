...
<h1 style="color:#242B5D; margin-top: 185px;">CLIENTES <?php echo $_GET['estado']; ?></h1>
    </div>
...
turnos.nroturno=turnos_proc.nroturno and turnos.idusuario=usuario.idusuario and turnos.nombre_departamento=departamentos.nombre_departamento and turnos_proc.estado='".$_GET['estado']."'  ;";
